...
// GPIO18: Toggles every adc cycle
// GPIO22: Toggles every control loop cycle
//
// Watch Variables:
// - Current1 => ADCINA5
// - Current2 => ADCINB5
...
// Function Prototypes
__interrupt void cla1_isr7(void);   // CLA task 7 ISR
__interrupt void controller(void);  // CPU Timer0 ISR
...
cla1_isr7(void)
{
    ...
    GpioDataRegs.GPATOGGLE.bit.GPIO18 = 1;  // Toggle GPIO18 for status
}
...
controller(void)
{
    ...
    #if PID1 || PID2
        controllerCount++;
        GpioDataRegs.GPATOGGLE.bit.GPIO22 = 1;  // Toggle GPIO22 for status
    #endif
...
init_gpio(void)
{
    ...
    GpioCtrlRegs.GPADIR.bit.GPIO18 = 1;     // GPIO18 is an output
    GpioCtrlRegs.GPADIR.bit.GPIO22 = 1;     // GPIO22 is an output
    EDIS;
}
