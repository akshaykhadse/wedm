...
// for the CLA in the linker command (.cmd) file.
    ...
    Uint32 current1Sum;
    #pragma DATA_SECTION(current1, "Cla1ToCpuMsgRAM");
    float current1;
#endif
#if I_SENS2
    ...
    Uint32 current2Sum;
    #pragma DATA_SECTION(current2, "Cla1ToCpuMsgRAM");
    float current2;
#endif
#if I_SENS3
    #pragma DATA_SECTION(current3Val, "Cla1DataRam0");
    Uint16 current3Val[FILTER_LEN];
    #pragma DATA_SECTION(current3Sum, "Cla1ToCpuMsgRAM");
    Uint32 current3Sum;
    #pragma DATA_SECTION(current3, "Cla1ToCpuMsgRAM");
    float current3;
#endif
#if V_SENS1
    ...
    Uint32 voltage1Sum;
    #pragma DATA_SECTION(voltage1, "Cla1ToCpuMsgRAM");
    float voltage1;
#endif
    #if V_SENS2
    ...
    Uint32 voltage2Sum;
    #pragma DATA_SECTION(voltage2, "Cla1ToCpuMsgRAM");
    float voltage2;
#endif
...
#endif
#if PID1
    float a1 = KP1 + KI1 * TS / 2.0 + 2.0 * KD1 / TS;
    float b1 = -KP1 + KI1 * TS / 2.0 - 2.0 * KD1 / TS;
    float c1 = KD1 / TS;
    float u1[2] = {0.0f, 0.0f};
    float e1[3] = {0.0f, 0.0f, 0.0f};
#endif
#if PID2
    float a2 = KP2 + KI2 * TS / 2.0 + 2.0 * KD2 / TS;
    float b2 = -KP2 + KI2 * TS / 2.0 - 2.0 * KD2 / TS;
    float c2 = KD2 / TS;
